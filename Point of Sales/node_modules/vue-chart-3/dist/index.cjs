...
var defineChartComponent = (chartName, chartType) => {
  ...
  return (0, import_vue.defineComponent)({
    ...
    setup(props, { emit, expose }) {
      ...
      (0, import_vue.watch)(() => props.options, (newOptions, oldOptions) => {
        if (chartInstance.value && newOptions && !(0, import_lodash_es.isEqual)(chartInstance.value.options, oldOptions)) {
          chartInstance.value.options = (0, import_lodash_es.cloneDeep)(newOptions);
          oldOptions = (0, import_lodash_es.cloneDeep)(newOptions);
          handleChartUpdate();
        }
      }, { deep: true });
      function watchHandler(newData, oldData) {
        if (oldData && chartInstance.value) {
          ...
          if (!(0, import_lodash_es.isEqual)(newData, oldData) && oldData.datasets.length === newData.datasets.length) {
